...
/**
 * Use this Lime MVC Module if you want to use Freemarker template engine for
 * rendering views.
 *
 * The module register and bind freemarker's Configuration instance into Guice
 * as a singleton.
 *
 * @see MvcModule
 */
...
// ------------------------------------------------------------------------
    ...
    /**
     * Constructor ov Freemarker module which loads template files from WAR as
     * JSPs.
     */
