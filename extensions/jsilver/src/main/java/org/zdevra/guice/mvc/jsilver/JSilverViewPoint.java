...
/**
 * The view implementation provide rendering of HTML page via JSIlver template
 * engine.
 *
 * If you want to return the instance of the view in your controller, ensure
 * that your MVC model is derived from {@link JSilverModel}
 *
 */
