...
/**
 * The module adds the JSilver template engine support into Lime MVC.
 *
 * <h3>Usage</h3> When you want to use JSilver template engine for view
 * rendering, you will install this JSilverModule in your MvcModule. After that
 * you may use {
 *
 * @ link ToJSilverView} and JSilverView.
 *
 * <p><br> <b>example:</b> <pre class="prettyprint"> public class MyModule
 * extends MvcModule { protected void configureControllers(VelocityEngine
 * velocity) { //setup controllers control("/*")... ... //setup views
 * install(new JSilverModule(getServletContext());
 * bindViewName("viewName").toViewInstance(new JSilverView("output.jsilver")); }
 * }
 * </pre>
 *
 * <h3>Model conversion</h3> The JSilver uses his own representation of data.
 * For this reason, the lime MVC have to converts his data to JSilver's data.
 * This is provided by Model Service and registered converters. If you want put
 * your own object into model, you will create converter by extending the
 * {@link ModelObjectConverter} and you will register the new converter calling
 * the registerModelConvertor() method. <p><br> <b>custom class:</b> <pre
 * class="prettyprint"> class Book { public final String name; public final
 * String author;
 *
 * public Book(String name, String author) { this.name = name; this.author =
 * author; } }
 * </pre> <br> <b>implementation of converter:</b> <pre class="prettyprint">
 ...
 *    }
 * }
 * </pre> <br> <b>registration of converter:</b> <pre class="prettyprint">
 * public class MyModule extends JSilverModule { protected void
 * configureControllers(JSilver jSilver) throws Exception { ...
...
// ------------------------------------------------------------------------
    /**
     * You will put your MVC configuration and convertor's registration into
     * this method.
     *
     * @param jSilver
     * @throws Exception
