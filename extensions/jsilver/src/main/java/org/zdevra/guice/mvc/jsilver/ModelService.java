...
/**
 * The class provide transformation of object to JSilver data. The class go
 * through all registered converters. If there is no matching converter, then is
 * used a default converter {@link ModelStringConverter}.
 */
@Singleton
class ModelService {
