...
/**
 * The parameter's processor forwards the session object into the method's
 * parameter. <p>
 *
 * <pre class="prettyprint"> {@literal @}Path("/somepath") public void
 * getInfoAboutLoggedUser(HttpSession session) { ... }
 * </pre> <p>
 *
 */
