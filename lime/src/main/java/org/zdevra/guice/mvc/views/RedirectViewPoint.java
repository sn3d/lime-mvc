...
/**
 * Viewpoint that do redirection to the URL.All request's attributes are posted as parameters. ContextRelative 
 * flag determines whether URL is relative to server or is relative to servlet path. Default value is true what
