...
/**
 * Abstract handler for simplest implementation when you want implement only pre
 * or post handing.
 */
public abstract class AbstractInterceptorHandler implements InterceptorHandler {
    ...
    /**
     * @see
     * org.zdevra.guice.mvc.InterceptorHandler#preHandle(javax.servlet.http.HttpServletRequest,
    ...
    /**
     * @see
     * org.zdevra.guice.mvc.InterceptorHandler#postHandle(javax.servlet.http.HttpServletRequest,
     * javax.servlet.http.HttpServletResponse,
    ...
    /**
     * @see
     * org.zdevra.guice.mvc.InterceptorHandler#afterCompletion(javax.servlet.http.HttpServletRequest,
