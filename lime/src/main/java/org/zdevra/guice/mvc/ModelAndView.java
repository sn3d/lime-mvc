 ...
 *
 * <p>example: <pre class="prettyprint"> {@literal @}Controller public class
 * BookController {
 *
 * {@literal @}Path("/home") public ModelAndView allBooks() { ModelMap m = ...;
 * View v = ...; ... return new ModelAndView(m, v); } }
 * </pre>
 */
public class ModelAndView {
    ...
    /*---------------------------- constructors ----------------------------*/
    /**
     * constructs a ModelAndView object and as a view is set undefined view
     * View.NULL_VIEW.
     */
    public ModelAndView() {
    ...
    /**
     * constructs a ModelAndView object with empty model and concrete view.
     *
     * @param view
     */
    ...
    /**
     * constructos a ModelAndView object with concrete model and view.
     *
     * @param model
     * @param view
     */
