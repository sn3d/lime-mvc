...
/**
 * Class provide default behaviour of a view's resolving.
 *
 * Resolver resolves only {@link NamedView} views. All other views are renderred
 * normally. Named views are translated to concrete views. In the MvcModule, you
 * may define translation rule for each named view. If there is no rule for
 * named view, view is transformed to {@link JspView}.
 *
 */
@Singleton
