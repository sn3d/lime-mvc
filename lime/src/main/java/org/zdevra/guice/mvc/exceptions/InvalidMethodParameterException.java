...
/**
 * The exception is throwed when the controller's method has the parameter which
 * source of data is undefined (parameter is without any known annotation like
 * {@link UriParameter} etc..
 *
