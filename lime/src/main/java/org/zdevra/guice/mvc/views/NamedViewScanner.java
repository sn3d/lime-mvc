...
/**
 * This implementation of the ViewScanner provides controller's and method's
 * scanning of an annotations for {@link NamedView}.
 *
 * This scanner goes though method's and controller's annotations, looking for
 * {@literal @}Controller and {@literal @}RequestMapping annotations and from
...
// ------------------------------------------------------------------------
    /**
     * This method looks for {@link ViewPoint} annotation and create
     * {@link NamedView}
     *
     * @param annotations
