...
/**
 * This view does nothing His purpose is to identify. All named views are
 * handled by view resolver which decide what view should be used.
 *
 * The named view is something like a default view used by Lime MVC. All view
 * are identified in the Lime MVC by names. After that, Lime MVC resolve view's
 * name to concrete view.
 *
 * Prefer this view as a controller's return view, because only named views are
 * handled by the Lime view resolver.
 *
...
// ------------------------------------------------------------------------
    ...
    /**
     * Factory static method which NamedView is constructed through.
     *
     * @param name
     * @return
     */
