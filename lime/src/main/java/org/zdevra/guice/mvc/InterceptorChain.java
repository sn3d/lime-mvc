...
/**
 * CLass represents the Chain of interceptor handlers and provide basic methods
 * for preprocessing and postprocessing for the whole chain.
 *
 */
...
// ------------------------------------------------------------------------
    ...
    /**
     * Method creates new extended chain and put new collection of handlers into
     * new chain.
     *
     * @param handlers
     * @return
