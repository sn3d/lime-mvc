...
/**
 * Class prepare data for controller's method, call the method and process the
 * method's result.
 *
 * For data preparation is used {@link ParamProcessorsService} which use
 * different processors defined in a package
 * {@link org.zdevra.guice.mvc.parameters}
 *
 */
class MethodInvokerImpl implements MethodInvoker {
    ...
    /**
     * Hidden constructor. The Invoker is constructed through the factory
     * methods.
     *
     * @param defaultView
     * @param resultName
