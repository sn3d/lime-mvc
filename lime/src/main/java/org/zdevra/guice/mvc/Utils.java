...
public final class Utils {
    ...
    /**
     * Method searchs annotation in annotations array and return it. If
     * annotation is not occured, then method return null.
     *
     * @param annotations
     * @return
     *
    ...
    /**
     * The method return all methods in the class annotated by concrete
     * annotation.
     *
     * @param annotation
     * @return
