...
/**
 * The class provides conversions from incomming strings from HTTP requests to a
 * various datatypes.
 *
 * The class is used internally by {@link MethodInvokerImpl}.
 *
 * You may implement and register your own converter. Just implements the
 * {@link ConversionService.Converter}, {@link ConversionService.ConverterFactory}
 * interfaces and in your configureControllers() register the converter:
 *
 * <pre class="prettyprint"> class MyModule extends MvcModule {
 *
 * protected void configureControllers() { ...
 * registerConverter(MyConverterFactory.class); ... } }
 * </pre>
 *
 * All supported converters in Lime are placed in package
 * {@link org.zdevra.guice.mvc.converters}.
 *
...
public class ConversionService {
    ...
    /**
     * Method return converter from given factory class. If factory class is
     * {@link NoConverterFactory}, then is called origin method of
     * getConverter()
     */
