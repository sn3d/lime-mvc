...
{		
	@Path("/people/new/second")  @View("/WEB-INF/view/form2.html.jsp")
	...
	@Path("/people")  @View("/WEB-INF/view/success.html.jsp")
	...
	@Path("/people/new")  @View("/WEB-INF/view/form.html.jsp")
	...
	@GET @Path("/people/rest")  @View("/WEB-INF/view/form-get.html.jsp")
	public Module getPeople()
	{
		return null;
	}
	
	@POST @Path("/people/rest")  @View("/WEB-INF/view/form-post.html.jsp")
