...
/**
 * This test class provide testing on integration level where the tested code is
 * running under embedded jetty and requests are executed via commons HttpClient
 *
 */
