...
// ------------------------------------------------------------------------
     ...
     * @return
     */
    private final static int getValueInt(String name, Map<String, String[]> data)
    {
...
// ------------------------------------------------------------------------
     ...
     * @return
     */
    private final static String getValue(String name, int index, Map<String, String[]> data)
    {
     ...
     * @return
     */
    private final static int getValueInt(String name, int index, Map<String, String[]> data)
    {
     ...
     * @return
     */
    private final static long getValueLong(String name, int index, Map<String, String[]> data)
    {
        String value = getValue(name, index, data);
     ...
     * @return
     */
    private final static double getValueDouble(String name, int index, Map<String, String[]> data)
    {
        String value = getValue(name, index, data);
     ...
     * @return
     */
    private final static Date getValueDate(String name, int index, DateFormat df, Map<String, String[]> data)
    {
        try {
            String value = getValue(name, index, data);
