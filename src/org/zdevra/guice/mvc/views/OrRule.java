...
/**
 * Router's rule representing OR operator between two rules.
 * The rule is usefull for composition of complex rules.
 */
public class OrRule implements ViewRouterRule {
	// ------------------------------------------------------------------------
...
// ------------------------------------------------------------------------
	...
	public OrRule(ViewRouterRule ruleA, ViewRouterRule ruleB) {
		this.ruleA = ruleA;
		this.ruleB = ruleB;
	}
